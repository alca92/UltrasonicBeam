...
public class Histogram {
     ...
     *
     * @param data  samples
     * @param nbins the number of bins the histogram should have. The range specified by min and max will be divided up into this
     *              many bins.
     ...
     *
     * @param fileName name of the file to write the histogram to. Note this must be valid for your operating system, e.g. a unix
