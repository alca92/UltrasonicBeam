...
public class Polynomial {
     ...
     * @throws IllegalArgumentException if numSamples is &le; 0
     ...
     *
     * @param other polynomial with the same order as this polynomial.
...
//	}
     ...
     * @param coeffs2 polynomial coefficients that are not null coeffs1, coeffs2 are expected to be coefficients of same order
     *                polynomials
