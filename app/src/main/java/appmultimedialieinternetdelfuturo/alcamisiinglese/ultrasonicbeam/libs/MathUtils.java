...
public class MathUtils {
     ...
     *
     * @param data double[]
     * @param opt  0: arithmetic mean, 1: geometric mean
     ...
     *
     * @param data double[]
     * @param opt  0: normalizes with N-1, this provides the square root of best unbiased estimator of the variance, 1: normalizes
     ...
     * @param meanVector  the vector of mean values -- a column vector if row-wise variances are to be computed, or a row vector if
     ...
     *
     * @param dbEnergy in time or frequency domain, on a db energy scale
...
//    }
     ...
     *
     * @param untrimmedValue untrimmedValue
     * @param min            min
     * @param max            max
